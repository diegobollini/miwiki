...
!!! tip "Relevante"
    En este mismo [repositorio](https://github.com/diegobollini/miwiki), además de los contenidos mismos del sitio, documento el proceso que pasé para implementar esto (Cloudflare Pages, MkDocs, Material...).
